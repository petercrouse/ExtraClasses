...
{
    public class GetStudentQueryHandler : IRequestHandler<GetStudentListQuery, StudentListViewModel>
    {
        private readonly IExtraClassesDbContext _context;
        private readonly IMapper _mapper;

        public GetStudentQueryHandler(IExtraClassesDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
